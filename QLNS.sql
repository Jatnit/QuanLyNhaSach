...
(
	MALINHVUC char(7) primary key not null,
...
(
	MANHAXUATBAN char(7) primary key not null,
...
(
	...
	MALINHVUC char(7) not null,
	MALOAISACH char(7) not null,
	GIAMUA int,
	GIABIA int,
	LANTAIBAN int,
	MANHAXUATBAN char(7) not null,
	NAMXUATBAN datetime
)
go
--insert into SACH
...
alter table SACH add constraint FK_SACH_LINHVUC foreign key(MALINHVUC) references LINHVUC(MALINHVUC)
